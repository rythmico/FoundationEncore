public enum DateOnlyEncoreOperationError: LocalizedError {
...
extension DateOnly {
    public static func + (lhs: Self, rhs: PeriodDuration) throws -> Self {
        guard let newDate = calendar.date(
            ...
            throw DateOnlyEncoreOperationError.cannotAddPeriodDuration(lhs, rhs)
        }
        return DateOnly(newDate, timeZone: timeZone)
    }
...
extension DateOnly {
    public static func + (lhs: Self, rhs: Period) throws -> Self {
        ...
        } catch is DateOnlyEncoreOperationError {
            throw DateOnlyEncoreOperationError.cannotAddPeriod(lhs, rhs)
        }
    }
...
extension DateOnly {
    public static func + (lhs: Self, rhs: Duration) throws -> Self {
        do {
            ...
            throw DateOnlyEncoreOperationError.cannotAddDuration(lhs, rhs)
        }
    }
